...
function Arrows({ prevSlide, nextSlide }) {
  return (
    <div className="w-full absolute top-2/3 md:top-1/2 transform -translate-y-2/3 md:-translate-y-1/2 flex justify-between px-4">
      <button className="text-[42px] sm:text-6xl lg:text-7xl text-redPink-1 hover:text-6xl hover:sm:text-7xl hover:lg:text-8xl ease-in-out
      ...
      transition-all ease-in-out duration-300 " onClick={nextSlide}>
